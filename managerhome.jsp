...
<body style="background-image: images/templatemo_body.jpg">
    ...
    <div id="templatemo_wrapper">
        ...
        <div id="menu">
            <ul class="navigation">
                <li><a href="#home" class="selected">Add Cabs<span class="ui_icon home"></span></a></li>
                <li><a href="#login">View Complaints<span class="ui_icon aboutus"></span></a></li>
                <li><a href="#register">Logout<span class="ui_icon services"></span></a></li>
        ...
        <div id="content">
            ...
            <div class="scroll">
                <div class="scrollContainer">
                    ...
                    <div class="panel" id="home" style="min-height: 300px; min-width: 400px;">
                    <!--     <h1>LOGIN FORM</h1> -->
